...
const packages = [
  {
    title: "ComicMind Starter",
    price: "$4.99",
    detail: "3 AI comic generations every month.",
  },
  {
    title: "ComicMind Pro",
    price: "$7.99",
    detail: "5 AI comic generations every month with higher image quality.",
    featured: true,
  },
  {
    title: "ComicMind Creator",
    price: "$19.99",
    detail: "15 AI comic generations every month with priority features.",
  },
];
...
export default function UserGuide() {
  ...
  const getPackageHref = () => (user ? "/pricing" : `/login?returnTo=${encodeURIComponent("/pricing")}`);
